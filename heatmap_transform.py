...
training_epochs = 500  # change later
change_epoch = 20
batch_size = 1
...
for epoch in range(training_epochs):
    ...
    if (epoch + 1) % change_epoch == 0:
        ...
        # torch.save(model.state_dict(),MODEL_PATH+str(epoch+1)+"_test_gaussian.pth")
torch.save(model.state_dict(), MODEL_PATH + "_test_log_500epoch.pth")